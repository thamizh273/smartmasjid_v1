...
class HomePage extends GetView<TimerController> {
      ...
      body: Center(
        child: CarouselSlider(
          items: [
            ...
            _buildSlide(controller,context),
            _buildSlide(controller,context),
            _buildSlide(controller,context),
          ],
  ...
  Widget _buildSlide(TimerController controller,context) {
    return Center(
      child: Container(
        height: 100,
        width: 200,
...
//   runApp(ScreenUtilInit(builder: (BuildContext context, Widget? child) {
...
//
// import 'package:smartmasjid_v1/main.dart';
//
// void main() {

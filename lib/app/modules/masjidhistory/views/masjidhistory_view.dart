                      ...
                      children: <Widget>[
                        ...
                        ConstrainedBox(
                          ...
                          child: SizedBox(
                            height: 250.h,
                            child: Obx(() {
                              return hiscntrl.isLoadings0.value
                                  ? DialogHelper.showLoading()
                                  : RefreshIndicator(
                                key: hiscntrl.refreshIndicatorKey,
                                onRefresh: hiscntrl.refreshData,
                        ...
                        ConstrainedBox(
                          ...
                          child: SizedBox(
                            height: 250.h,
                            child: Obx(() {
                              return hiscntrl.isLoadings1.value
                                  ? DialogHelper.showLoading()
                                  :   RefreshIndicator(
                                key: hiscntrl.refreshIndicatorKey,
                                onRefresh: hiscntrl.refreshData,
                                ...
                                child: GridView.builder(
                                        ...
                                        physics: BouncingScrollPhysics(),
                                        itemCount: hiscntrl.getmasjidgallery.value.getMasjidGalleryImages!.length,
                                        itemBuilder: (context, index) {
                                          var data = hiscntrl.getmasjidgallery.value.getMasjidGalleryImages![index];

                                          // Create a unique hero tag for each image
                                          final heroTag = 'image_$index';

                                          return GestureDetector(
                                            onTap: () {
                                              // When an image is tapped, navigate to a full-screen view
                                                    ...
                                                    body: Center(
                                                      child: Hero(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Image.memory(
                                                            Uint8List.fromList(data.image!.data!),
                                                            fit: BoxFit.fill,
                                                          ),
                                                        ),
                                                      ),
                                            ...
                                            child: Hero(
                                              tag: heroTag, // Specify the same hero tag as in the full-screen view
                                              child: Padding(
            ...
            children: <Widget>[
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    "Info",
                    style: (homecntrll.activePageIndex.value == 0)
                        ? TextStyle(

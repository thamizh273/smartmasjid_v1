...
class LargerCard extends StatelessWidget {
  const LargerCard({
    ...
    required this.quranImg, required this.buttonTxt, required this.image, required this.title, required this.subtitle,  this.lastseen, this.onTap, this.ignorOntap,

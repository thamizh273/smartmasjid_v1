  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Masjid-e-nooraniah", style: TextStyle(color: Theme
              .of(context)
              .primaryColor),),
          actions: [
            Padding(
...
// >>>>>>> e709a5633b4df46d42e82bb4447e9d16336dcf0f
          ],
          bottom: buildPreferredSize(context),
        ),
        body: FrostedBottomBar(

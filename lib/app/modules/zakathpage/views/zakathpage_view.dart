              ...
              children: [
                ...
                ElevatedButton(
                    onPressed: ()  async {
                      ...
                      // if(mounted){
                        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => ZakathSummary(data: data)));
                      // }
                    },
...
class _ZakathSummaryState extends State<ZakathSummary> {
  ...
  Widget build(BuildContext context) {
    ...
    final gas = (get('24kg') * get('24kgrpg'))+ (get('22kg') * get('22kgrpg')) + (get('silv') * get('silvrpg'));
    final dal = get('dtf') + get('dtfr') + get('dtr') + get('dto') + get('bp')+ get('op');
            ...
            children: [
              tableItem(
                  Column(
                    children: [
                      Row(
                        children: [
                          tableItem(Text('Particulars', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w700),)),
                          tableItem(Text('Amount',  style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w700),), alignment: Alignment.center),
                        ],
                      ),
                      Row(
                        children: [
                          tableItem(Text('Cash', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w500),)),
                          tableItem(SelectableText(NumberFormat.currency(symbol: '').format(cash),), alignment: Alignment.center),
                        ],
                      ),
                      Row(
                        children: [
                          tableItem(Text('Gold & Silver', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w500),)),
                          tableItem(SelectableText(NumberFormat.currency(symbol: '').format(gas),), alignment: Alignment.center),
                        ],
                      ),
                      Row(
                        children: [
                          tableItem(Text('Rent & Income', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w500),)),
                          tableItem(SelectableText(NumberFormat.currency(symbol: '').format(rai),), alignment: Alignment.center),
                        ],
                      ),
                      Row(
                        children: [
                          tableItem(Text('Debts & Liabilities', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor, fontWeight: FontWeight.w500),)),
                          tableItem(SelectableText(NumberFormat.currency(symbol: '').format(dal),), alignment: Alignment.center),
                        ],
                      ),
                      Row(
                        children: [
                          tableItem(Text('Total', style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w700),), alignment: Alignment.centerRight),
                          tableItem(SelectableText(NumberFormat.currency(symbol: '').format(total), style: const TextStyle(fontWeight: FontWeight.w600),), alignment: Alignment.center),
                        ],
                      ),
                      Row(
                        children: [
                          tableItem(Text('Zakath (2.5%)', style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w700),), alignment: Alignment.centerRight),
                          tableItem(SelectableText(NumberFormat.currency(symbol: '').format(zakath), style: const TextStyle(fontWeight: FontWeight.w600)), alignment: Alignment.center),
                        ],
                      ),
                    ],
                  ),
              ...
              Row(
                children: [
                  const Spacer(),
                  const Space(16),
                  Expanded(child: Text('Payable Amount', style: Theme.of(context).textTheme.titleSmall?.copyWith(color: Theme.of(context).primaryColor.withOpacity(0.9)),))
                ],
              )
            ],
          ),)
  ...
  Widget tableItem(Widget child, {bool expanded = true, Alignment alignment = Alignment.centerLeft, EdgeInsets padding = const EdgeInsets.symmetric(horizontal: 10, vertical: 8)}){

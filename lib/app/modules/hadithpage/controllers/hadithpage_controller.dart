...
class HadithpageController extends GetxController {
  ...
  ScrollController scrollControllerd = ScrollController();
...
query Get_Hadiths_Collection(\$masjidId: String) {
  ...
  hadithChapters(String? collection_name_en,) async {
...
query Get_Hadiths_Chapter_By_Collection(\$collectionName: String!) {
  Get_Hadiths_Chapter_By_Collection(collection_name: \$collectionName) {
    ...
    var body = {
      "collectionName": "$collection_name_en",
  ...
  hadithDetail(String? collection_name_en, String? chapter_no) async {

    print("vvvvvv${collection_name_en}");
    print("zzzzzz${chapter_no}");
    isLoadings5.value = true;
    var header = """

              ...
              children: [
                Obx(() {
                  return SafaDropdownButton2(
                    ...
                    dropdownItems: const ["This Year", "Last Year"],
                              ...
                              children: [
                                Row(
                                  children: [
                                    Stxt(
                                        text:
                                            '${DateFormat('MMMM yyyy').format(DateTime.parse(data.paymentMonth.toString()))}',
                                        // text: "June 2023",
                                        size: f3,
                                ...
                                Obx(() {
                                  return   (controller.expand[index] && controller.expandedIndex.value == index)
                                      ? Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Stxt(
                                                  text: "${DateFormat('dd/MM/yyyy').format(DateTime.parse(data.paymentDate!.toLocal().toString()))}",
                                                  size: f2,
                                                  weight: FontWeight.w500,
                                                ),
                                              ],

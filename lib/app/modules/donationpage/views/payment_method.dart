...
import 'package:smartmasjid_v1/app/modules/donationpage/controllers/donationpage_controller.dart';
...
class PaymentMethod extends StatelessWidget {
  ...
  final donatectrl = Get.put(DonationpageController());
                  ...
                  Obx(() {
                    return  Transform.scale(
                      ...
                      child: Radio(
                        ...
                        // title: Text("Amiri"),
                        value: "upi",
                        groupValue: donatectrl.fontFamily.value,
                        onChanged: (groupValue) =>
                        donatectrl.fontFamily.value = groupValue!,
                      ),
                    );
                  }),
                  Space(8),

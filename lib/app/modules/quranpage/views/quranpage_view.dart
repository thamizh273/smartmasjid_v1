                  ...
                  children: [
                    ...
                    Expanded(
                      child: Scrollbar(
                        ...
                        child: Obx(() {
                          return c.isLoadings.value?loading(context): ListView.builder(
                            // shrinkWrap: true,
                              itemCount: c.getqurandata.value.quranFilter!.length,
                              itemBuilder: (context, index) {
                                var sura = c.getqurandata.value.quranFilter![index];
                                return Container(
                                  color: c.currentSelected == index ? Color(
                                      0xffEBEBEB) : Color(0xff16627C),
                                  child: ListTile(
                                    dense: true,
                                    title: Row(
                                      children: [
                                        Text("${sura.suraChapterNo}.", style: TextStyle(
                                            color: c.currentSelected == index
                                                ? Color(0xff16627C)
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Icon(Icons.bookmark_add_outlined,
                                            color: Color(0xff16627C),),
                                          Text("${sura.totalVerses}", style: TextStyle(
                                              color: Color(0xff16627C),
                                              fontSize: 12),)
                                        ],
                                      ),

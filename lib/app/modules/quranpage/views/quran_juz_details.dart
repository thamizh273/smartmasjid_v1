                        ...
                        child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Stxt(text: "Juz", size: f2, color: Theme
                                    .of(context)
                        ...
                        child: Column(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Obx(() {
                                ...
                                return Row(
                                  ...
                                  children: [
                                    Text(
                                      "${ctrl.juzChapterNo}.", style: TextStyle(
                                        fontWeight: FontWeight.w600,
                                        fontSize: 13,
                                        color: Theme
                                            .of(context)
                            ...
                            Obx(() {
                              final ctrl = c.getquranjuzdetail.value
                                  .getQuranJuzVersesList![0];
                              return Stxt(text: "${ctrl.juzNameArb}", size: f1,
                                color: Theme
                                    .of(context)
                                    .primaryColor,);
                            })
                            ...
                            children: [
                              ...
                              Obx(() {
                                final ctrl = c.getquranjuzdetail.value
                                    .getQuranJuzVersesList![0];
                                return Stxt(
                                  text: "${ctrl.totalVerses}", size: f2, color: Theme
                                    .of(context)
                                    .primaryColor, weight: FontWeight.w500,);
                              })
                            ],
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              ...
                                              onTap: () {
                                                print('ssss${c.getquranjuzdetail
                                                    .value
                                                    .getQuranJuzVersesList![0]
                                                    .juzNameEn}');

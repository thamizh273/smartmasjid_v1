...
class WeatherdetailView extends StatelessWidget {
          ...
          return c.isLoadings1.value
            ...
            children: [
              Obx(() {
                ...
                var daywise = c.getweatherdata.value
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${witem.tempC!.round()}\u00B0C",
                                style: TextStyle(
                                    fontSize: 55.w, color: Colors.white),
                              ),
                            ],
                          ),
                          Stxt(
  ...
  Padding daywiseWeather(day, icon, rain, temp, wind, humidity, condition,
